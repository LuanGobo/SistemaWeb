...
namespace SalesWeb.Data
{
    public class SeedingServices
    {
        ...
        public SeedingServices(SalesWebContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1995, 5, 15), 1000.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "Alex@gmail.com", new DateTime(2000, 6, 1), 1000.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "Martha@gmail.com", new DateTime(1985, 7, 2), 1000.0, d3);
            Seller s5 = new Seller(5, "Donald Blue", "Donald@gmail.com", new DateTime(1974, 8, 21), 1000.0, d4);
            Seller s6 = new Seller(6, "Alex Pink", "Alex@gmail.com", new DateTime(2005, 10, 30), 1000.0, d4);
